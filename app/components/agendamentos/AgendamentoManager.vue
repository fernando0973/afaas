<template>
  <div class="flex flex-col h-full">
    ...
    <div class="pt-4 flex-shrink-0 border-b border-neutral-200">
      <!-- Primeira linha: 3 componentes principais -->
      <div class="h-[80px] grid grid-cols-3 items-center">
    ...
    <div class="flex-1 flex overflow-hidden">
      ...
      <div class="w-20 flex-shrink-0 border-r border-neutral-200 overflow-y-auto">
